...
import com.concurrency.test.refactored.ServerWithThreadingRefactored;

public class ClientTestWithThreadingRefactored {
	private static final int PORT = 8009;
	private static final int TIMEOUT = 2000;

	ServerWithThreadingRefactored server;
	Thread serverThread;

	@Before
	public void createServer() throws Exception {
		try {
			server = new ServerWithThreadingRefactored(PORT, TIMEOUT);
